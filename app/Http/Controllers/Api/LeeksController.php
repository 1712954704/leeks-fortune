...
class LeeksController extends BaseController
{
    ...
    */
    public function search_leeks()
    {
        ...
        $list = [];
        if ($total > 0){
            $sql = "select a.date,a.code,b.name,b.manager,b.fundScale,sum(a.worth) total_worth from leeks_fund_worth_detail a inner join leeks_fund b on a.code = b.code where a.date between :start_time and :end_time group by a.code order by total_worth $order,b.fundScale desc limit :limit,:pos";
